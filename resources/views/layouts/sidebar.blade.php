    ...
    <div class="nav flex-column gap-1">
        ...
        @auth
            ...
            @if (auth()->user()->role === 'petugas')
                <a href="dashboard" class="nav-link {{ request()->is('petugas/dashboard') ? 'active' : '' }}">
                    <i class="bi bi-speedometer2 me-2"></i> Dashboard
                </a>

                <a href="peminjaman" class="nav-link {{ request()->is('petugas/peminjaman*') ? 'active' : '' }}">
                    <i class="bi bi-handbag me-2"></i> Peminjaman
                </a>

                <a href="pengembalian" class="nav-link {{ request()->is('petugas/pengembalian*') ? 'active' : '' }}">
                    <i class="bi bi-check2-circle me-2"></i> Pengembalian
                </a>

                <a href="laporan" class="nav-link {{ request()->is('petugas/laporan*') ? 'active' : '' }}">
                    <i class="bi bi-envelope-paper me-2"></i> Laporan
                </a>
                <a href="/petugas/log-aktivitas"
                    class="nav-link {{ request()->is('petugas/log-aktivitas*') ? 'active' : '' }}">
                    <i class="bi bi-clock-history me-2"></i> Log Aktivitas
                </a>
            @endif
            ...
            @if (auth()->user()->role === 'peminjam')
                <a href="dashboard" class="nav-link {{ request()->is('peminjam/dashboard') ? 'active' : '' }}">
                    <i class="bi bi-speedometer2 me-2"></i> Dashboard
                </a>

                <a href="alat" class="nav-link {{ request()->is('peminjam/alat*') ? 'active' : '' }}">
                    <i class="bi bi-box-seam me-2"></i> Daftar Alat
                </a>

                <a href="peminjaman" class="nav-link {{ request()->is('peminjam/peminjaman*') ? 'active' : '' }}">
                    <i class="bi bi-handbag me-2"></i> Peminjaman
                </a>

                <a href="pengembalian" class="nav-link {{ request()->is('peminjam/pengembalian*') ? 'active' : '' }}">
                    <i class="bi bi-check2-circle me-2"></i> Pengembalian
                </a>

                <a href="log-aktivitas" class="nav-link {{ request()->is('peminjam/log-aktivitas*') ? 'active' : '' }}">
                    <i class="bi bi-clock-history me-2"></i> Log Aktivitas
                </a>
            @endif
