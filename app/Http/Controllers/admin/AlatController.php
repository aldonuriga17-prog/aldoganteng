    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()
                ->withInput()
                ->withErrors(['database' => 'Terjadi kesalahan saat menyimpan alat. Pastikan data valid dan coba lagi.']);
        } catch (\Exception $e) {
            // Handle other exceptions
            return redirect()->back()
                ->withInput()
                ->withErrors(['general' => 'Terjadi kesalahan tidak terduga. Silakan coba lagi.']);
        }
    }
